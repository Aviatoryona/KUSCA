        ...
        try {
            ...
            for (int i = 0; i < typedArray.getIndexCount(); i++) {
                ...
                if (attr == R.styleable.FButton_shadowEnabled) {
                    ...
                    mButtonColor = typedArray.getResources().getColor(R.color.fbutton_default_color);//getColor(attr,attr,getResources().getColor(R.color.fbutton_default_color)R.color.fbutton_default_color,null));
                } else if (attr == R.styleable.FButton_shadowColor) {
                    mShadowColor = typedArray.getColor(attr,getResources().getColor(R.color.fbutton_default_shadow_color));//.getResources().getColor(R.color.fbutton_default_shadow_color);//getColor(attr,R.color.fbutton_default_shadow_color);
                    isShadowColorDefined = true;
                } else if (attr == R.styleable.FButton_shadowHeight) {
                    mShadowHeight = typedArray.getDimensionPixelSize(attr, getResources().getDimensionPixelSize(R.dimen.fbutton_default_shadow_height));
                } else if (attr == R.styleable.FButton_cornerRadius) {
                    mCornerRadius = typedArray.getDimensionPixelSize(attr,getResources().getDimensionPixelSize(R.dimen.fbutton_default_conner_radius)); //R.dimen.fbutton_default_conner_radius);
                }
            }
            typedArray.recycle();
